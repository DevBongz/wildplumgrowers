[![VercelLogotype](https://vercel.com/vc-ap-vercel-docs/_next/static/media/vercel-logotype-light.64164313.svg?dpl=dpl_Bv5VzXgoG7bJA7gC88inmDN63Pce)![VercelLogotype](https://vercel.com/vc-ap-vercel-docs/_next/static/media/vercel-logotype-dark.49dd0a95.svg?dpl=dpl_Bv5VzXgoG7bJA7gC88inmDN63Pce)](https://vercel.com/home)

![Vercel](https://vercel.com/vc-ap-vercel-docs/_next/static/media/vercel-light.cb298fd7.svg?dpl=dpl_Bv5VzXgoG7bJA7gC88inmDN63Pce)![Vercel](https://vercel.com/vc-ap-vercel-docs/_next/static/media/vercel-dark.d798e77e.svg?dpl=dpl_Bv5VzXgoG7bJA7gC88inmDN63Pce)
...
- Products
  ...
  - ##### [AI Cloud](https://vercel.com/ai)
    ...
    - [v0\\
      \\
      Build applications with AI](https://v0.app/)
    - [AI SDK\\
      \\
    ...
    - [Sandbox\\
      \\
      AI workflows in live environments](https://vercel.com/sandbox)
  - ##### Core Platform
...
- Resources
  ...
  - ##### Learn
    ...
    - [Academy\\
      \\
      Linear courses to level up](https://vercel.com/academy)
    - [Knowledge Base\\
      \\
      Find help quickly](https://vercel.com/kb)
    - [Community\\
      \\
      Join the conversation](https://community.vercel.com/)
  - ##### Open Source
...
This guide uses the [Next.js Commerce template](https://vercel.com/templates/ecommerce/nextjs-commerce) to connect your Shopify store to a Vercel deployment. When you use this template, you'll be automatically prompted to connect your Shopify storefront during deployment.

To finish, the important parts that you need to know are:

- [Configure Shopify for use as a headless CMS](https://vercel.com/docs/integrations/ecommerce/shopify#configure-shopify)
- [Deploy your headless storefront on Vercel](https://vercel.com/docs/integrations/ecommerce/shopify#deploy-to-vercel)
- [Configure environment variables](https://vercel.com/docs/integrations/ecommerce/shopify#configure-environment-variables)

Even if you are not using Next.js Commerce, you can still use this guide as a
roadmap to create your own headless Shopify theme.

## [Getting started](https://vercel.com/docs/integrations/ecommerce/shopify\#getting-started)

To help you get started, we built a [template](https://vercel.com/templates/ecommerce/nextjs-commerce) using Next.js, Shopify, and Tailwind CSS.

[![Next.js Commerce](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2Fe5382hct74si%2F1RzhtOHEvW7xyn9qAsdr5E%2F85331c32482b7d022585c39ddb3ae9f2%2FCleanShot_2023-07-24_at_21.37.15_2x.png&w=3840&q=75)\\
\\
Next.js Commerce\\
\\
Starter kit for high-performance commerce with Shopify.](https://vercel.com/templates/next.js/nextjs-commerce)
...
## [Configure Shopify](https://vercel.com/docs/integrations/ecommerce/shopify\#configure-shopify)

01. ### [Create a Shopify account and storefront](https://vercel.com/docs/integrations/ecommerce/shopify\#create-a-shopify-account-and-storefront)
    ...
    Next.js Commerce will not work with a Shopify Starter plan as it does not
    allow installation of custom themes, which is required to run as a headless
    storefront.

02. ### [Install the Shopify Headless theme](https://vercel.com/docs/integrations/ecommerce/shopify\#install-the-shopify-headless-theme)
    ...
    ![Download the Shopify Headless theme](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Finstall-headless-theme-1.jpg&w=3840&q=75)
    Navigate to , click , and then .
    ![Upload the Shopify Headless theme to Shopify](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Finstall-headless-theme-2.jpg&w=3840&q=75)
    Select the downloaded zip file from above, and click the green  button.
    ![Select downloaded Shopify Headless theme and upload file](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Finstall-headless-theme-3.jpg&w=3840&q=75)
    Click .
    ![Customize the Shopify Headless theme](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Finstall-headless-theme-4.jpg&w=3840&q=75)
    Click  (the paintbrush icon), expand the  section, enter your headless store domain, click the gray  button.
    ![Set the headless domain in theme settings](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Finstall-headless-theme-5.jpg&w=3840&q=75)
    Confirm the theme change by clicking the green  button.
    ![Confirm save and publish](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Finstall-headless-theme-6.jpg&w=3840&q=75)
    The headless theme should now be your current active theme.
    ![Shopify Headless theme is now the current and active theme](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Finstall-headless-theme-7.jpg&w=3840&q=75)
03. ### [Install the Shopify Headless app](https://vercel.com/docs/integrations/ecommerce/shopify\#install-the-shopify-headless-app)
    ...
    ![Shopify App Store](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Finstall-headless-app-1.jpg&w=3840&q=75)
    Search for  and click on the  app.
    ![Search and find Headless app](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Finstall-headless-app-2.jpg&w=3840&q=75)
    Click the black  button.
    ![Click add app on Headless app](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Finstall-headless-app-3.jpg&w=3840&q=75)
    Click the green  button.
    ![Click add sales channel button](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Finstall-headless-app-4.jpg&w=3840&q=75)
    Click the green  button.
    ![Click create storefront button](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Finstall-headless-app-5.jpg&w=3840&q=75)
    Copy the public access token as it will be used when we [configure environment variables](https://vercel.com/docs/integrations/ecommerce/shopify#configure-environment-variables).
    ![Copy the public access token value](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Finstall-headless-app-6.jpg&w=3840&q=75)
    If you need to reference the public access token again, you can navigate to .

04. ### [Configure your Shopify branding and design](https://vercel.com/docs/integrations/ecommerce/shopify\#configure-your-shopify-branding-and-design)
...
05. ### [Customize checkout, order status, and order history](https://vercel.com/docs/integrations/ecommerce/shopify\#customize-checkout-order-status-and-order-history)



    Navigate to  and click the green  button.
    ![Customize checkout](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fbranding-1.jpg&w=3840&q=75)
    Click  (the paintbrush icon) and customize your brand.




    There are three steps / pages to the checkout flow. Use the dropdown to change
    pages and adjust branding as needed on each page. Click  when you are
    done.



    ![Customize checkout branding](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fbranding-2.jpg&w=3840&q=75)
    Navigate to  and customize settings to match your brand.
    ![Customize order status and history branding](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fbranding-3.jpg&w=3840&q=75)
06. ### [Customize emails](https://vercel.com/docs/integrations/ecommerce/shopify\#customize-emails)



    Navigate to  and customize settings to match your brand.
    ![Customize email branding](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fbranding-4.jpg&w=3840&q=75)
07. ### [Customize favicon](https://vercel.com/docs/integrations/ecommerce/shopify\#customize-favicon)



    Navigate to  and click the green  button.
    ![Customize favicon](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fbranding-5.jpg&w=3840&q=75)
    Click  (the paintbrush icon), expand the  section, upload favicon, then click the  button.
    ![Save favicon customizations](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fbranding-6.jpg&w=3840&q=75)
08. ### [Configure Shopify webhooks](https://vercel.com/docs/integrations/ecommerce/shopify\#configure-shopify-webhooks)
...
09. ### [Create a secret for secure revalidation](https://vercel.com/docs/integrations/ecommerce/shopify\#create-a-secret-for-secure-revalidation)



    Create your own secret or [generate a random UUID](https://www.uuidgenerator.net/guid).

    This secret value will be used when we [configure environment variables](https://vercel.com/docs/integrations/ecommerce/shopify#configure-environment-variables).

10. ### [Configure Shopify webhooks in the Shopify admin](https://vercel.com/docs/integrations/ecommerce/shopify\#configure-shopify-webhooks-in-the-shopify-admin)



    Navigate to  and add webhooks for all six event topics listed above.
    ...
    ![Shopify storefront webhooks](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fwebhooks-1.jpg&w=3840&q=75)![Add a Shopify storefront webhook](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fwebhooks-2.jpg&w=3840&q=75)
11. ### [Testing webhooks during local development](https://vercel.com/docs/integrations/ecommerce/shopify\#testing-webhooks-during-local-development)
...
![ngrok information](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fwebhooks-3.jpg&w=3840&q=75)![Edit Shopify storefront webhook](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fwebhooks-4.jpg&w=3840&q=75)
...
![Send a test notification from a Shopify storefront webhook](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fwebhooks-5.jpg&w=3840&q=75)

### [Using Shopify as a full-featured CMS](https://vercel.com/docs/integrations/ecommerce/shopify\#using-shopify-as-a-full-featured-cms)
...
#### [Products](https://vercel.com/docs/integrations/ecommerce/shopify\#products)
...
#### [Collections](https://vercel.com/docs/integrations/ecommerce/shopify\#collections)
...
![Shopify collections](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fcollections-1.jpg&w=3840&q=75)![Shopify collection details](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fcollections-2.jpg&w=3840&q=75)

#### [Pages](https://vercel.com/docs/integrations/ecommerce/shopify\#pages)
...
- If a page is found, it will display its rich content using [Tailwind's typography plugin](https://tailwindcss.com/docs/typography-plugin) and .
- If a page is not found, a  page is displayed.

![Shopify pages](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fpages-2.jpg&w=3840&q=75)![Shopify page details](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fpages-1.jpg&w=3840&q=75)

#### [Navigation menus](https://vercel.com/docs/integrations/ecommerce/shopify\#navigation-menus)
...
![Shopify navigation menus](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fnavigation-menus-1.jpg&w=3840&q=75)![Shopify navigation menu details](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fnavigation-menus-2.jpg&w=3840&q=75)

#### [SEO](https://vercel.com/docs/integrations/ecommerce/shopify\#seo)
...
![Shopify SEO](https://vercel.com/vc-ap-vercel-docs/_next/image?url=https%3A%2F%2F7nyt0uhk7sse4zvn.public.blob.vercel-storage.com%2Fdocs-assets%2Fstatic%2Fdocs%2Fintegrations%2Fshopify%2Fseo.jpg&w=3840&q=75)

## [Deploy to Vercel](https://vercel.com/docs/integrations/ecommerce/shopify\#deploy-to-vercel)

Now that your Shopify store is configured, you can deploy your code to Vercel.

### [Clone the repository](https://vercel.com/docs/integrations/ecommerce/shopify\#clone-the-repository)

You can clone the repo using the following command:

### [Publish your code](https://vercel.com/docs/integrations/ecommerce/shopify\#publish-your-code)

Publish your code to a Git provider like GitHub.

### [Import your project](https://vercel.com/docs/integrations/ecommerce/shopify\#import-your-project)

Import the repository into a [new Vercel project](https://vercel.com/new).

Vercel will automatically detect you are using Next.js and configure the optimal build settings.

### [Configure environment variables](https://vercel.com/docs/integrations/ecommerce/shopify\#configure-environment-variables)

Create [Vercel Environment Variables](https://vercel.com/docs/environment-variables) with the following names and values.

- _(optional)_ — Displayed in the footer next to the copyright in the event the company is different from the site name, for example
- — Used to connect to your Shopify storefront, for example
- — Used to secure API requests between Shopify and your headless site, which was created when you [installed the Shopify Headless app](https://vercel.com/docs/integrations/ecommerce/shopify#install-the-shopify-headless-app)
- — Used to secure data revalidation requests between Shopify and your headless site, which was created when you [created a secret for secure revalidation](https://vercel.com/docs/integrations/ecommerce/shopify#create-a-secret-for-secure-revalidation)
- — Displayed in the header and footer navigation next to the logo, for example
- — Used in Twitter OG metadata, for example
- — Used in Twitter OG metadata, for example

You can [use the Vercel CLI to setup your local development environment variables](https://vercel.com/docs/environment-variables#development-environment-variables) to use these values.
...
- [Getting started](https://vercel.com/docs/integrations/ecommerce/shopify#getting-started)
- [Configure Shopify](https://vercel.com/docs/integrations/ecommerce/shopify#configure-shopify)
- [Create a Shopify account and storefront](https://vercel.com/docs/integrations/ecommerce/shopify#create-a-shopify-account-and-storefront)
- [Install the Shopify Headless theme](https://vercel.com/docs/integrations/ecommerce/shopify#install-the-shopify-headless-theme)
- [Install the Shopify Headless app](https://vercel.com/docs/integrations/ecommerce/shopify#install-the-shopify-headless-app)
- [Configure your Shopify branding and design](https://vercel.com/docs/integrations/ecommerce/shopify#configure-your-shopify-branding-and-design)
- [Customize checkout, order status, and order history](https://vercel.com/docs/integrations/ecommerce/shopify#customize-checkout-order-status-and-order-history)
- [Customize emails](https://vercel.com/docs/integrations/ecommerce/shopify#customize-emails)
- [Customize favicon](https://vercel.com/docs/integrations/ecommerce/shopify#customize-favicon)
- [Configure Shopify webhooks](https://vercel.com/docs/integrations/ecommerce/shopify#configure-shopify-webhooks)
- [Create a secret for secure revalidation](https://vercel.com/docs/integrations/ecommerce/shopify#create-a-secret-for-secure-revalidation)
- [Configure Shopify webhooks in the Shopify admin](https://vercel.com/docs/integrations/ecommerce/shopify#configure-shopify-webhooks-in-the-shopify-admin)
- [Testing webhooks during local development](https://vercel.com/docs/integrations/ecommerce/shopify#testing-webhooks-during-local-development)
- [Using Shopify as a full-featured CMS](https://vercel.com/docs/integrations/ecommerce/shopify#using-shopify-as-a-full-featured-cms)
- [Products](https://vercel.com/docs/integrations/ecommerce/shopify#products)
- [Collections](https://vercel.com/docs/integrations/ecommerce/shopify#collections)
- [Pages](https://vercel.com/docs/integrations/ecommerce/shopify#pages)
